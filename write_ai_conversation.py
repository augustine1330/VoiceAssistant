code = """# commands/ai_conversation.py
import requests
from config import OLLAMA_URL, CONVERSATION_MODEL

SYSTEM_PROMPT = TRIPLE_QUOTE
...
code = code.replace("TRIPLE_QUOTE", '\"\"\"')

with open("commands/ai_conversation.py", "w", encoding="utf-8") as f:
    f.write(code)
print("ai_conversation.py written successfully")